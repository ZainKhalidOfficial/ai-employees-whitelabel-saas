...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp dark:bg-gray-dark relative z-10 pt-16 md:pt-20 lg:pt-24 bg-gradient-to-tr from-indigo-100 via-indigo-400 to-indigo-200 overflow-auto"
        data-wow-delay=".1s"
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              ...
              <p className=" mb-32 text-6xl">
                Stay in <br/> the Know
                </p>
                <Link href="/" className="mb-4 inline-block">

                 <p className="text-[#6F5AF6]  text-xl font-semibold leading-relaxed text-body-color">
                 Vitexy
                 </p>
                </Link>

                <p className="text-black mb-4 text-lg font-normal leading-relaxed text-body-color">
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-3xl font-normal text-black dark:text-white">
